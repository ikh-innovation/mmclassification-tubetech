...
train_dataloader = dict(batch_size=2, dataset=dict(
    data_prefix='../boiler_defects_dataset_tiled_v1/train',
    pipeline=train_pipeline))
val_dataloader = dict(batch_size=2, dataset=dict(
    data_prefix='../boiler_defects_dataset_tiled_v1/valid',
    pipeline=test_pipeline))
test_dataloader = dict(batch_size=2, dataset=dict(
    ...
    vis_backends=[
        ...
        dict(type='WandbVisBackend',
             init_kwargs=dict(project='boiler_defects_classification',
                              name='efficientnet-b8_2xb2_in1k-640px_bd_tiled_v1',
                              ),
