...
val_dataloader = dict(batch_size=6, dataset=dict(pipeline=test_pipeline))
test_dataloader = dict(batch_size=6, dataset=dict(pipeline=test_pipeline))
    ...
    vis_backends=[
        ...
        dict(type='WandbVisBackend',
             init_kwargs=dict(project='boiler_defects_classification',
                              name='efficientnet-b5_1xb6_in1k-456px',
                              ),
